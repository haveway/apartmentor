...
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '가', '가', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '나', '나', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '다', '다', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '라', '라', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '마', '마', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '바', '바', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '사', '사', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '아', '아', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '자', '자', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '차', '차', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '차 사고 싶다..', '차 사고 싶다..', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'AAA', 'AAA', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'BBB', 'BBB', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'CCC', 'CCC', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'DDD', 'DDD', '서영재', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 5);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'EEE', 'EEE', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'FFF', 'FFF', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'GGG', 'GGG', '서영재', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 5);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'HHH', 'HHH', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'III', 'III', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, 'JJJ', 'JJJ', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '아파트 앞에 커피집 맛있네요', '리얼루 맛있어요! 맨날가야지 ㅋ', '고성수', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, '[정보]', 3);
INSERT INTO BOARD
...
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '우리 동네 아파트 엄마들 안녕하세요~!', '어머니들 모임이나 회식을 따로 가지시는지 궁급합니다!!', '서영재', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, '[맘]', 5);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '층간 소음 건의합니다. 매우 화가 났어요!', '301동 501호 아이들이 새벽에도 쿵쿵거리는데 시끄러워서 잠이안옵니다..', '홍길동', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, '[건의]', 2);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '애기전용 BMW팝니다~!', '가속 성능과 핸들링의 쾌적성 등의 주행능력을 높인 BMW-BABY5 시리즈입니다.', '손동환', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, '[판매]', 6);
INSERT INTO BOARD
...
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '아파트 산책 시 주의사항', '일몰시간에 맞춰 산책을 하시면 붉은 야경과 함께 어우러지는 배경이 환상적입니다. 놓치지마세요!', '김유미', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, '[정보]', 4);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '어머니들 쓰레기 처리 관련 질문있어요!', '음식물 쓰레기는 분리수거하는 요일 이외에 버려도 상관없나요??', '조성준', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, '[맘]', 8);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '주택청약으로 들어오신 분들 참고하시라고 정보 고유합니다.', '당첨된 청약통장은 계약 체결 여부와 관계없이 재사용 불가하지만 청약통장을 사용하여 분양전환되지 않는 임대주택에 당첨된 경우 재사용 가능하다네요^^', '서영재', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, '[정보]', 5);
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '우영우 너무 재밌다 ㅋㅋ', '너무 재밌어서 안나가고 정주행중입니다 ㅎㅎ', '임유리', NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 7);
INSERT INTO BOARD
...
INSERT INTO REPLY
VALUES (SEQ_BRNO.NEXTVAL, '저도 이뻐서 친구들한테 자랑중 ㅋㅋ', '김유미', 1, DEFAULT, DEFAULT, 4);
INSERT INTO REPLY
VALUES (SEQ_BRNO.NEXTVAL, '이쁘다 이쁘다 이쁘다니까~', '고성수', 1, DEFAULT, DEFAULT, 3);
INSERT INTO REPLY
VALUES (SEQ_BRNO.NEXTVAL, '야경이 미쳤네요 ㄷㄷ', '손동환', 1, DEFAULT, DEFAULT, 6);
INSERT INTO REPLY
VALUES (SEQ_BRNO.NEXTVAL, '정말 죄송합니다 주의할께요!', '조성준', 3, DEFAULT, DEFAULT, 8);
...
INSERT INTO CHAT
VALUES (SEQ_CHNO.NEXTVAL, '혹시 201호 예비군 우편 왔나요??', TO_DATE('22/08/15 10:30', 'RR/MM/DD HH24:MI'), 2, '1동201호', 3);
INSERT INTO CHAT
...
INSERT INTO VISIT
VALUES (SEQ_VNO.NEXTVAL, 3, 12, '2022-08-25', '09:40', 'Y', NULL, DEFAULT);
INSERT INTO VISIT
